...
![RNN vs Klasik Sinir Ağı Karşılaştırması](/images/transformer-blog/RNNvsNN.png "RNN vs Klasik Sinir Ağı Karşılaştırması"){: width="1596" height="720"}
...
![Basit bir TR-EN çevirisi, encoder-decoder örneği](/images/transformer-blog/encoder-decoder-basit-ornek.PNG "Basit bir TR-EN çevirisi, encoder-decoder örneği"){: loading="lazy" width="432" height="74"}
...
![Attention Mekanizması](/images/transformer-blog/attention-mekanizmasi.PNG "Attention Mekanizması"){: loading="lazy" width="827" height="341"}
...
![Makaledeki Transformer Yapısı](/images/transformer-blog/transformer-arch.png "Makaledeki Transformer Yapısı"){: loading="lazy" width="617" height="853"}
...
![ULMFiT Yaklaşımı](/images/transformer-blog/ulmfit-yaklasimi.png "ULMFiT Yaklaşımı"){: loading="lazy" width="1600" height="377"}
