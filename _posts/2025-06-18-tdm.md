---
description: DeepSeek-R1 muhakeme modelini Türkçe için nasıl uyarladığımı anlatıyorum; TÜDÜM'ün veri seti, eğitim süreci ve sonuçları.
---

# TÜDÜM: TÜrkçe Düşünen Üretken Model

![TÜDÜM maskotu: fes takmış, tüylerinde devre deseni olan bir baykuş kitap yığınının üzerinde](/images/tdm-blog/tudum_baykusu.jpg){: width="1024" height="1536"}
...
![PPO Yapısı](/images/tdm-blog/ppo_diagram.avif "PPO Yapısı"){: loading="lazy" width="768" height="437"}
...
![GRPO Yapısı](/images/tdm-blog/grpo_diagram.avif "GRPO Yapısı"){: loading="lazy" width="768" height="437"}
